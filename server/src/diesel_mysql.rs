...
pub fn stage() -> AdHoc {
    AdHoc::on_ignite("Diesel SQLite Stage", |rocket| async {
        ...
        .mount("/api/native-v1/event", routes![crate::endpoint::event::event_list, crate::endpoint::event::event_create])
        .mount("/api/native-v1/account", routes![crate::endpoint::account::account_me])
